class Game {
    ...
    private createRooms() {
        let basic1: Room = new RoomBasic303(Game.loadNewImage('assets/img/rooms/room3'), this.canvas.width, this.canvas.height)
        let basic2: Room = new RoomSky403(Game.loadNewImage('assets/img/rooms/room7'), this.canvas.width, this.canvas.height)
        let bath: Room = new RoomBath401(Game.loadNewImage('assets/img/rooms/room4'), this.canvas.width, this.canvas.height)
        let beach: Room = new RoomBeach402(Game.loadNewImage('assets/img/rooms/room6'), this.canvas.width, this.canvas.height)
        let chinese: Room = new RoomChinese400(Game.loadNewImage('assets/img/rooms/room5'), this.canvas.width, this.canvas.height)
        let future: Room = new RoomFuture301(Game.loadNewImage('assets/img/rooms/room1'), this.canvas.width, this.canvas.height)
        let penthouse: Room = new RoomPenthouse302(Game.loadNewImage('assets/img/rooms/room2'), this.canvas.width, this.canvas.height)
